...
* <b>Windows</b>: http://rubyinstaller.org/
* <b>Everything else and extra info</b>: http://www.ruby-lang.org/en/downloads/

If you wanna learn some basic Ruby, then go to http://tryruby.org/ and type help. Excellent tutorial there. This is not really necessary unless you wanna help me fix the script, but it's a really cool language to learn! :)
...
http://github.com/godfreykfc/hearts-judge/downloads
